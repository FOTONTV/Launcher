package fun.fotontv.launcher.client.gui.scenes.serverinfo;
...
import fun.fotontv.launcher.client.gui.scenes.servermenu.ServerButtonComponent;
...
import fun.fotontv.launcher.request.auth.SetProfileRequest;
