...
public final class IOHelper {
    ...
    public static final Path JVM_DIR = Paths.get(System.getProperty("user.dir") + PLATFORM_SEPARATOR + "runtime");
    public static final Path HOME_DIR = Paths.get(System.getProperty("user.dir") + PLATFORM_SEPARATOR + "home");
    ...
    private record MoveFileVisitor(Path from, Path to) implements FileVisitor<Path> {
    ...
    private record SkipHiddenVisitor(FileVisitor<Path> visitor) implements FileVisitor<Path> {
