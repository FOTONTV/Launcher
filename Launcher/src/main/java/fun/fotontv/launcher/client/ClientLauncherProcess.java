...
import fun.fotontv.launcher.client.events.client.ClientProcessBuilderCreateEvent;
import fun.fotontv.launcher.client.events.client.ClientProcessBuilderLaunchedEvent;
import fun.fotontv.launcher.client.events.client.ClientProcessBuilderParamsWrittedEvent;
import fun.fotontv.launcher.client.events.client.ClientProcessBuilderPreLaunchEvent;
...
import fun.fotontv.launcher.profiles.optional.actions.OptionalActionClientArgs;
import fun.fotontv.launcher.profiles.optional.actions.OptionalActionJvmArgs;
import fun.fotontv.launcher.request.Request;
import fun.fotontv.launcher.serialize.HOutput;
import fun.fotontv.utils.Version;
import fun.fotontv.utils.helper.*;
...
import static fun.fotontv.utils.helper.IOHelper.PLATFORM_SEPARATOR;
...
public class ClientLauncherProcess {
    ...
    public ClientLauncherProcess(Path clientDir, Path assetDir,
                                 ClientProfile profile, PlayerProfile playerProfile, String accessToken,
                                 HashedDir clientHDir, HashedDir assetHDir, HashedDir jvmHDir) {
        this(clientDir, assetDir, Paths.get(System.getProperty("user.dir") + PLATFORM_SEPARATOR + "runtime"), clientDir.resolve("resourcepacks"), profile, playerProfile, null, accessToken, clientHDir, assetHDir, jvmHDir);
    }
    ...
    private void applyJava9Params(List<String> processArgs) {
        ...
        Path openjfxPath = JavaHelper.tryGetOpenJFXPath();
