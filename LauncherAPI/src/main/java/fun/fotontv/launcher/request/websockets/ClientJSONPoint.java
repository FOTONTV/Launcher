...
import fun.fotontv.launcher.CertificatePinningTrustManager;
import fun.fotontv.launcher.LauncherInject;
    ...
    public ClientJSONPoint(URI uri) throws SSLException {
        ...
        bootstrap.group(group)
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    @Override
                    public void initChannel(@SuppressWarnings("NullableProblems") SocketChannel ch) {
